...
import com.smile.calendar.databinding.ActivityAddScheduleBinding;
 ...
 * 添加日程
 */
public class AddDeleteActivity extends AppCompatActivity implements OnDateSetListener {
    ...
    private ActivityAddScheduleBinding bindingView;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bindingView = DataBindingUtil.setContentView(this, R.layout.activity_add_schedule);
        ...
        if(bundle != null) {
            ...
            if (!TextUtils.isEmpty(eventId)) {
                ...
                if (eventModels != null && eventModels.size() > 0) {
                    ...
                    bindingView.titleEt.setText(eventModel.getName());
                    bindingView.positionEt.setText(eventModel.getF1());
                    ...
                    bindingView.startTime.setText(startTime.toString());
                    ...
                    bindingView.endTime.setText(endTime.toString());
                    try {
                        if (TimeUtil.compare_current(endTime.toString())) {
                            bindingView.titleEt.setEnabled(false);
                            bindingView.positionEt.setEnabled(false);
                            bindingView.startTime.setEnabled(false);
                            bindingView.endTime.setEnabled(false);
//                            setRightTitle("");
                            canEdit = false;
                        }
                    } catch (Exception e) {
...
//                    String title = bindingView.titleEt.getText().toString().trim();
//                    String pos = bindingView.positionEt.getText().toString().trim();
...
//    }
    ...
    public void onDateSet(TimePickerDialog timePickerView, long millseconds) {
        if (flag == 0) {
            ...
            bindingView.startTime.setText(startTime);
            ...
            bindingView.endTime.setText(endTime);
            LocalDate datetimeDate = new LocalDate(millseconds);
